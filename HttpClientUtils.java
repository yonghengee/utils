...
public class HttpClientUtils {
    ...
    public static String doGet(String url, Map<String, Object> params) {
        ...
        try {
            ...
            if (entity != null) {
                ...
                result =
                        IOUtils.toString(instream, "UTF-8");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) {
		...
		paramsMess.put("userIds", "3123032346002432,3138429741384704");
		paramsMess.put("content",json);
		doPost("http://huangzhaoman.w3.luyouxia.net/messapi/push/pushOtherServiceAndSome", paramsMess);
	}
