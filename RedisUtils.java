...
public class RedisUtils {
    ...
    public RedisUtils() {
        try {
            ...
            String ip = (String) props.get("redis.host");
            Integer port = Integer.parseInt(props.get("redis.port").toString());
            String password = (String) props.get("redis.pass");
            Integer maxTotal = Integer.parseInt(props.get("redis.maxTotal").toString());
            Integer maxIdle = Integer.parseInt(props.get("redis.maxIdle").toString());
            Integer maxWaitMillis = Integer.parseInt(props.get("redis.maxWaitMillis").toString());
            Integer timeBetweenEvictionRunsMillis = Integer.parseInt(props.get("redis.timeBetweenEvictionRunsMillis").toString());
            Integer minEvictableIdleTimeMillis = Integer.parseInt(props.get("redis.minEvictableIdleTimeMillis").toString());
            Integer timeout = Integer.parseInt(props.get("redis.timeout").toString());
            if (pool == null) {
        	...
        	e.printStackTrace();
        	logger.debug("Redis连接未知异常e:" + e.getLocalizedMessage());
        }
    }
    ...
    public static void main(String[] args) {
		RedisUtils.getInstance().setex("18476508132", "123456", 3600);
		String value = RedisUtils.getInstance().get("18476508132");
